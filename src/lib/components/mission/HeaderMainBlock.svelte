<script lang="ts">
    ...
    let img = `${base}/newImg/Header.png`;

    export let exit: () => void;
</script>

<div  style="background-image: url({img});"
     class="h-full land:h-[97%] w-[95%] port:w-[93%] mx-auto  bg-no-repeat bg-center text-center  flex flex-col mt-[-20.5%] port:mt-[-16.5%] justify-center items-center  port:text-[6.41vw] vhFont-[110] font-['Fira_Sans'] font-black bg-contain tablet">
</div>
