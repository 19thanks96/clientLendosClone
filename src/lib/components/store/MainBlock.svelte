...
<div class="flex content-start  flex-wrap justify-start flex-col w-full">
    <div class="w-full flex justify-center items-center flex-col ">
        <div style={`background-image: url(${base}/newImg/Img_Str_Header.png); filter: drop-shadow(0vw 0.25vw 0.25vw rgb(21, 20, 19))`}
             class="vwWidth-[447] land:mt-[-1.75vw] vwHeight-[200] port:w-[87vw] z-[3] port:h-[39vw] bg-contain bg-bottom bg-no-repeat flex justify-center items-end port:mt-[-9%] relative">
        ...
        <div style={`border-image-source: url(https://p2w.imgix.net/resources/client/store/Cmt_Str_Bg_PopUp_Main.png?auto=compress&auto=format);`}
             class="relative flex justify-start main-store vwWidth-[357] vwHeight-[570] port:w-[69vw] port:h-[110vw] rounded-[5%] ">
            <ShowCase {goodsArray}/>
        </div>
    </div>
</div>
